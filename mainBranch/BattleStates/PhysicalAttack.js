...
demo.PhysicalAttack = function (game_state, name, position, properties) {
    "use strict";
    demo.Attack.call(this, game_state, name, position, properties);
};

demo.PhysicalAttack.prototype = Object.create(demo.Attack.prototype);
demo.PhysicalAttack.prototype.constructor = demo.PhysicalAttack;

demo.PhysicalAttack.prototype.hit = function (target) {
    "use strict";
