...
demo.MagicAttack = function (game_state, name, position, properties) {
    "use strict";
...
demo.MagicAttack.prototype = Object.create(demo.Attack.prototype);
demo.MagicAttack.prototype.constructor = demo.MagicAttack;

demo.MagicAttack.prototype.hit = function (target) {
    "use strict";
